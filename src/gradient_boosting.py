...
def gradient_boosting(X_train, X_test, y_train, y_test, categorical_columns, numerical_columns, binary_columns, output_column_name, output_column_type):
    warnings.simplefilter(action='ignore', category=FutureWarning)
    start_time = time.time()

    with open('config/gradient_boosting.yaml', 'rb') as file:
    ...
    if output_column_type == 'numerical':
        ...
        param_grid = {
            ...
            'model__learning_rate': model_cfg['learning_rate'] 
        }
    ...
    joblib_file = "./model/gradient_boosting_pipeline.pkl"
